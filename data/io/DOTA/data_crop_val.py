...
raw_data = '/home/sommarjobbare/Downloads/our_book_dataset_1.0'
raw_images_dir = os.path.join(raw_data, 'images', 'images')
raw_label_dir = os.path.join(raw_data, 'labelTxt', 'labelTxt')

save_dir = '/home/sommarjobbare/Downloads/our_book_dataset_2.0'
...
img_h, img_w, stride_h, stride_w = 2976, 3968, 0, 0
